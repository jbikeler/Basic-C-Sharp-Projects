    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            if (playerName.ToLower() == "admin")
            {
                ...
                {
                    Console.WriteLine(exeption.Id + " | ");
                    Console.WriteLine(exeption.ExceptionType + " | ");
                    Console.WriteLine(exeption.ExceptionMessage + " | ");
                    Console.WriteLine(exeption.TimeStamp + " | ");
                    Console.WriteLine();
                }
                Console.Read();
                return;
            ...
            if (answer == "yes" || answer == "y" || answer == "ya" || answer == "yeah")
            {
                ...
                using (StreamWriter file = new StreamWriter(@"C:\Users\jbike\OneDrive\Desktop\MyText.txt", true))
                {
